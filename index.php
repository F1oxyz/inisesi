        ...
        if(!empty($_POST['nombre']) && !empty($_POST['apellidos']) && !empty($_POST['user']) && !empty($_POST['email']) && !empty($_POST['password'])){
            ...
            if(mysqli_connect_error()){
                ...
                if($rnum == 0){
                    ...
                    $carta .= "Acabamos de dar de alta tu cuenta, Gracias por elegir 
                    este software para aprender \n";
                    $carta .= "Aqui podras aprender el pasado de los verbos regulares e irregulares
                    jugando, puedes crear en modo arena competitivamente ¡Ademas de que puedes crear
                    tus propias salas con verbos personalizados! \n";
...
<body>
    <header>
        <nav>
            <a href="./index.html">
                <img src="./img/icons8-motherboard-96.png" alt="">
                prueba
            </a>
                ...
                <div class="div-form">
                    <fieldset>
                        ...
                        <form method="post">
                            ...
                            <input type="text" id="usuario" name="user" placeholder="Introduce tu usuario" required> <br>

                            <label for="contraseña">Contraseña</label> <br>
                            <input type="password" id="contraseña" name="password" placeholder="Introduce tu contraseña" required><br>
